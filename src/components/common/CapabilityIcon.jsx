...
const paths = {
  crm: (
    ...
    >
      <g clipPath="url(#clip0_4303_1230)">
        <g clipPath="url(#clip1_4303_1230)">
          <path
            d="M8 8.64804C8 1.48532 12.793 -0.307119 18.0014 0.0408311C54.9592 2.50996 88 13.4612 88 27.5274V70.8626C88 64.136 81.2063 58.5112 70.6791 54.1048C69.0821 53.4363 68.0037 51.8953 68.0037 50.164V36.0118C68.0037 27.913 64.6065 24.5176 58.0039 22.6303C51.4013 20.743 47.9957 22.8343 47.9957 30.273V37.3692C47.9957 42.3552 44.744 45.6372 39.0108 46.5734C33.2776 47.5096 28.4108 48.0653 21.0075 48.7346C13.6041 49.4039 8 44.6457 8 36.59V8.64804Z"
          ...
          />
          <path
            d="M88.0001 27.5273C88.0001 39.0611 66.8268 48.0295 40.0001 52.4565C33.2484 53.5707 28.0001 56.7291 28.0001 63.7778V85.3022C28.0001 95.5107 34.1437 96.8549 41.998 95.5107C70.1946 90.6848 88.0001 80.7717 88.0001 70.8265V27.5273Z"
          ...
          <path
            opacity="0.5"
            d="M68.0001 62.3574C68 70.7401 65.071 73.7092 58.004 75.7236C51.8306 77.4834 48.0001 76.807 48.0001 68.0771V50.9639C55.4017 49.4174 62.1948 47.5071 68.0001 45.2783V62.3574Z"
            fill="url(#paint5_linear_4303_1230)"
          />
        </g>
      </g>
      <defs>
        <linearGradient id="paint0_linear_4303_1230" x1="18.1333" y1="2.1153" x2="47.1826" y2="60.9552" gradientUnits="userSpaceOnUse">
          <stop stopColor="#367AF2" />
          <stop offset="0.28721" stopColor="#2764E7" />
          <stop offset="0.660233" stopColor="#4A43CB" />
        ...
        <radialGradient id="paint1_radial_4303_1230" cx="0" cy="0" r="1" gradientTransform="matrix(17.6607 52.344 -119.087 40.8452 39.9393 1.5962)" gradientUnits="userSpaceOnUse">
          <stop offset="0.619721" stopColor="#5750E2" stopOpacity="0" />
        ...
        <radialGradient id="paint2_radial_4303_1230" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(30.5 50.6874) rotate(-90) scale(53.3687 95.7281)">
          <stop offset="0.55" stopColor="#2764E7" stopOpacity="0" />
          <stop offset="1" stopColor="#AC80FF" />
        </radialGradient>
        <linearGradient id="paint3_linear_4303_1230" x1="67.4738" y1="92.9706" x2="67.4738" y2="36.9473" gradientUnits="userSpaceOnUse">
          ...
          <stop offset="0.40599" stopColor="#2764E7" />
          <stop offset="1" stopColor="#BD96FF" />
        </linearGradient>
        <linearGradient id="paint4_linear_4303_1230" x1="73.2633" y1="49.8376" x2="88.0001" y2="49.8376" gradientUnits="userSpaceOnUse">
          <stop stopColor="#367AF2" stopOpacity="0" />
          <stop offset="0.488848" stopColor="#4BA3F3" stopOpacity="0.3769" />
          <stop offset="1" stopColor="#6FE8F5" />
        </linearGradient>
...
<rect width="96" height="96" fill="white"/>
  ...
  migration: (
    ...
    >
      <defs>
        <linearGradient id="migration-fill" x1="4" y1="4" x2="20" y2="20" gradientUnits="userSpaceOnUse">
          <stop stopColor="#1F8F5F" />
          <stop offset="1" stopColor="#0D5E9C" />
        </linearGradient>
      </defs>
      <rect x="3.2" y="4.2" width="7.6" height="6.6" rx="1.4" fill="url(#migration-fill)" />
      <rect x="13.2" y="13.2" width="7.6" height="6.6" rx="1.4" fill="url(#migration-fill)" />
      <path d="M7.8 7.5H10.2" stroke="#fff" strokeWidth="1.2" strokeLinecap="round" />
      <path d="M10.2 7.5L8.5 5.8" stroke="#fff" strokeWidth="1.2" strokeLinecap="round" />
      <path d="M10.2 7.5L8.5 9.2" stroke="#fff" strokeWidth="1.2" strokeLinecap="round" />
      <path d="M16.2 16.5H13.8" stroke="#fff" strokeWidth="1.2" strokeLinecap="round" />
      <path d="M13.8 16.5L15.5 14.8" stroke="#fff" strokeWidth="1.2" strokeLinecap="round" />
      <path d="M13.8 16.5L15.5 18.2" stroke="#fff" strokeWidth="1.2" strokeLinecap="round" />
    </svg>
  ),
  transform: (
    <svg
...
export function CapabilityIcon({ name, className }) {
  ...
  return (
    ...
    >
      <g transform="translate(0.5 0.5) scale(0.92)">
        {paths[name] ?? null}
      </g>
    </svg>
  );
